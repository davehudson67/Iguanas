...
## load IS samples
logimpweight_e <- readRDS("LImpWeights/logimpweight_e.rds")
logimpweight_g <- readRDS("LImpWeights/logimpweight_g.rds")
logimpweight_gm <- readRDS("LImpWeights/logimpweight_gm.rds")
logimpweight_s <- readRDS("LImpWeights/logimpweight_s.rds")
