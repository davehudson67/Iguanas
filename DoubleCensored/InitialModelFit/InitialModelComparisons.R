...
## load IS samples
logimpweight_e <- readRDS("DoubleCensored/LImpWeights/logimpweight_e.rds")
logimpweight_g <- readRDS("DoubleCensored/LImpWeights/logimpweight_g.rds")
logimpweight_gm <- readRDS("DoubleCensored/LImpWeights/logimpweight_gm.rds")
logimpweight_s <- readRDS("DoubleCensored/LImpWeights/logimpweight_s.rds")
