...
run <- readRDS("DoubleCensored/All_Island_Data/Samples/G_AllIslands_SexFeeding3_RETime_a.rds")
...
postdf <- rename(postdf,
                 betaFEEDmida = betaFEEDmid,
                 betaFEEDmidb = betaFEEDmid.1,
                 betaFEEDnoa  = betaFEEDno,
                 betaFEEDnob  = betaFEEDno.1,
                 betaSEXa     = betaSEX,
                 betaSEXb     = betaSEX.1,
                 zFEEDa       = zFEED,
                 zFEEDb       = zFEED.1,
