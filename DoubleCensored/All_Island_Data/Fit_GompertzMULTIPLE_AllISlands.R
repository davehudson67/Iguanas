...
# igsALL has dupicate observations removed (iguanas seen twice in a year)
...
## set up data
consts <- list(nind = nind, tMax = ncol(CH) -25, nISLANDS = 8, sex = sex, island = as.numeric(as.factor(island)))
