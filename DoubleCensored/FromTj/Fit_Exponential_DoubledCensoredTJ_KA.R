...
## Load data
igs <- read_csv("Data/AllIslandsThru2019_CleanOct2020.csv")
...
saveRDS(run, "Samples/E_dc_AllIslandsKA.rds")
#run <- readRDS("Samples/E_dc_AllIslandsKA.rds")
#run$summary
...
saveRDS(logimpweight, "DoubleCensored/LImpWeights/logimpweight_E_KA_ALL.rds")
logimpweight <- readRDS("DoubleCensored/LImpWeights/logimpweight_E_KA_ALL.rds")
